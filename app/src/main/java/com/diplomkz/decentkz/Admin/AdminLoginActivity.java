                            ...
                            .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        myRootRef.child("Admin").child(currentUserId).addListenerForSingleValueEvent(new ValueEventListener() {
                                            ...
                                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                                ...
                                                if (dataSnapshot.exists()) {
                                                    ...
                                                    Toast.makeText(AdminLoginActivity.this, "Привет АДМИН", Toast.LENGTH_SHORT).show();
                                                    startActivity(intent);
                                                    finish();
                                                } else {
                                                    mAuth.signOut();
                                                    Toast.makeText(AdminLoginActivity.this, "Вы ввели неверно", Toast.LENGTH_SHORT).show();
                                        ...
                                        //show message
                                        Toast.makeText(AdminLoginActivity.this, "Не смогли войти",
