...
import com.diplomkz.decentkz.Adapter.CartCustomAdapter;
...
public class CheckOutActivity extends AppCompatActivity {
                ...
                builder.setPositiveButton("Да", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        if(order.getTotalPrice()>0){
                            ...
                            Toast.makeText(CheckOutActivity.this, "В корзине нет товаров", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void settingDataOnServer() throws ParseException {
        pd.show(this,"Пожалуйста подождите..","Submitting order..");
        ...
        root.child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(key).setValue(order).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void aVoid) {
                ...
                pd.dismiss();
                Toast.makeText(CheckOutActivity.this,"Заказ сохранен",Toast.LENGTH_LONG).show();
            }
        });
